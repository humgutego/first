...
<link href="<c:url value=" ${pageContext.request.contextPath}/resources/common.css" />" rel="stylesheet" type="text/css"/>ext.request.contextPath}/resources/common.css" />
<title>変更完了ページ</title>
<style type="text/css">
.enjoyService{
	margin:30px;
...
<div class="main">
	<div class="wrappInner">
    	<h1>ﾏｲﾍﾟｰｼﾞ登録内容変更完了</h1>
        <hr />
        <div class="content">
        	<h2>ﾏｲﾍﾟｰｼﾞの登録内容を変更しました。</h2>
            	<div class="enjoyService">
                    <p>Music Life Agency Online Rentalサービスをお楽しみください&nbsp;♪</p>
                </div>
            </div>
        </div>
    </div>
